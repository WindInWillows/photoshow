...
<div class="pageright">
<div class="subnav clearfix"><span class="l">TEAM</span>
<ul class="l">
	<li><a href="/about.php">私人定制</a>&nbsp;&nbsp;/&nbsp;&nbsp;</li>
	<li class="selected"><a href="/team.php">技术团队</a>&nbsp;&nbsp;/&nbsp;&nbsp;</li>
...
<div align="right"> <?php if(isset($_SESSION["account"])) echo '<a href="admin/edit_about.php?opt=2">编辑</a>&nbsp;&nbsp;';?><?=$date==null ? "" : $date?></div>
<hr /><br /><br />
