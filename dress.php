...
<meta name="author" content="婚纱礼服_不二公社" />
<meta name="copyright" content="婚纱礼服_不二公社" />
...
--> 
            <div class="subnav clearfix">
				...
				<ul class="l">
					<li ><a href="/about.php">私人定制</a>&nbsp;&nbsp;/&nbsp;&nbsp;</li>
					<li ><a href="/team.php">技术团队</a>&nbsp;&nbsp;/&nbsp;&nbsp;</li>
					<li class="selected"><a href="/dress.php">婚纱礼服</a></li>
				</ul>
			</div>			
            <div class="about">
			<p>
	<img alt="" src="/upload/image/1453967630-2206.png" style="width: 873px; height: 1144px;" /></p>
